var tags=document.getElementsByTagName("a");for(i=0;i<tags.length;i++){tags[i].onclick=function(){if((this.getAttribute('href')!='https://animeszone.net/')&&(this.getAttribute('href')!='https://animeszone.net/')){if(LerCookie('Encaminhamento')!="encaminhado"){openWindow('https://mangaszone.top/');}
GerarCookie('Encaminhamento','encaminhado',3600);};}}
